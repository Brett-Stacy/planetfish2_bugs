...
#### For Paul
Why would numbers at age agree so well but SSB doesn't agree?
Are the time steps SSB is calculated the same between OM and CASAL?
...
datass.TOA = readRDS("C:/Users/bstacy/Documents/GitHub/planetfish2_bugs/Output/TOA_bug_2/datass.Rds")
# estimation = extract.csl.file("C:/Users/STA384/Documents/GitHub/planetfish2_bugs/Output/TOA_bug_2/casal_estimation.csl")
estimation = extract.csl.file("C:/Users/bstacy/Documents/GitHub/planetfish2_bugs/Output/TOA_bug_2/casal_estimation.csl")
# population.TOA = extract.csl.file("C:/Users/STA384/Documents/GitHub/planetfish2_bugs/Output/TOA_bug_2/casal_population.csl")
population.TOA = extract.csl.file("C:/Users/bstacy/Documents/GitHub/planetfish2_bugs/Output/TOA_bug_2/casal_population.csl")
...
lines(100*ogive("dbnormal", 1:35, params = list(top=10, sigma_left=2, sigma_right=10)))
...
res.TOA = readRDS("C:/Users/bstacy/Documents/GitHub/planetfish2_bugs/Output/TOA_bug_2/res.Rds")
output.TOA = extract.quantities("C:/Users/bstacy/Documents/GitHub/planetfish2_bugs/Output/TOA_bug_2/casalout_output.log")
...
## POPULATION OM AGE FREQUENCY VS AM ESTIMATED AGE FREQUENCY
res.TOA = readRDS("C:/Users/bstacy/Documents/GitHub/planetfish2_bugs/Output/TOA_bug_2/res.Rds")
para.TOA = readRDS("C:/Users/bstacy/Documents/GitHub/planetfish2_bugs/Output/TOA_bug_2/para.Rds")
output.TOA = extract.quantities("C:/Users/bstacy/Documents/GitHub/planetfish2_bugs/Output/TOA_bug_2/casalout_output.log")
output.TOA2 = read.csv("C:/Users/bstacy/Documents/GitHub/planetfish2_bugs/Output/TOA_bug_2/TOA_bug_2_Niter_1000.csv")
est.age.om = res.TOA$pop$n[,,1,,]*2
est.age.am = output.TOA$Numbers_at_age_R1
...
points(SSB.am2[nrow(output.TOA2), ], col = "red")
...
### TOP
```{r, echo=F}
datass.TOP = readRDS("C:/Users/bstacy/Documents/GitHub/planetfish2_bugs/Comparisons/datass_TOP_6_6_19")
estimation = extract.csl.file("C:/Users/bstacy/Documents/GitHub/planetfish2_bugs/Comparisons/casal_estimation_TOP.csl")
...
points(age.am*500, col = "red", pch = 3)
lines(500*ogive("dbnormal", 1:30, params = list(top=10, sigma_left=2, sigma_right=10)))
...
## POPULATION OM AGE FREQUENCY VS AM ESTIMATED AGE FREQUENCY
res.TOP = readRDS("C:/Users/bstacy/Documents/GitHub/planetfish2_bugs/Comparisons/res_TOP_31_5_19")
output.TOP = extract.quantities("C:/Users/bstacy/Documents/GitHub/planetfish2_bugs/Comparisons/casalout_output2_TOP_11_6_19.log")
