...
## 16/9/19
##
## PATAGONIAN TOOTHFISH UNDERCATCH SIMULATION
## FOR CHAPTER 3
## TEST: DO IUU TAGS GET INTO CASAL?
# sum(res$obs$LL2$tag_N) = 0
# LL1 fishing/tagging 2000-2004 then no fishing. LL2 fishing entire 1990-2010. Result: no tagging showed up past 2004 in population.csl, meaning LL2 not contributing tagged/recaptured fish to assessment.


n_iters = 1
under_const_prop = 0.10
...
## House ----
casal_path = "C:/Users/bstacy/Documents/GitHub/planetfish2_bugs/Output/TOA_bug_12/"
setwd(casal_path)
para = get_om_data()
...
catch_LL1     = 6000 # set to 0 didn't work. needs at least 100 tonnes.
catch_LL2     = 6000 # set for test
...
para$om$catch[, para$om$fishery[1], 1, 1] = c(rep(catch_LL1, 15), rep(0, 6))
