...
## LOOK AT TAGGING STUFF. switch recaptured and scanned as per casal manual.
##### CONCLUSION: got this error: Error: Less scanned fish than recaptured fish for an age/size class in year 2006 in Tag_recapture observations Tags2005_R1_R1.
## I think Phil had them the right way round the first time. This is also the way they have them in the example 3 in A. Dunn's casal lesson.
...
## House ----
casal_path = "C:/Users/STA384/Documents/GitHub/planetfish2_bugs/Output/TOA_bug_17/"
setwd(casal_path)
para = get_om_data()
...
temp1 = read.csv(paste0(casal_path, "Output_Niter_10.csv"))
years = 1990:2010
