...
## try pushing aged tagged fish to casal instead of lengthed.
...
## House ----
casal_path = "C:/Users/STA384/Documents/GitHub/planetfish2_bugs/Output/TOA_bug_18/"
setwd(casal_path)
para = get_om_data()
...
################################# Mess with tagging by age-size ----
# para$ass$tag_sampling_type = "age-size"
