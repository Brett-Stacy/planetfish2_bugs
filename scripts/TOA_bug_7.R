...
plot(x, z, type = "l", main = "TOP default VB Weight", xlab = "Age", ylab = "Weight")
plot(x, m, type = "l", main = "TOP default Maturity", xlab = "Age", ylab = "Probability Mature")
plot(x, s, type = "l", main = "TOP Paul Selectivity", xlab = "Age", ylab = "Probability Selected")
...
# BS 18/7/19: try changing this back to default: 0.5
