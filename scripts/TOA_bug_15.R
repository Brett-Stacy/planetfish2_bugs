...
## House ----
casal_path = paste0("C:/Users/", Sys.info()["login"], "/Documents/GitHub/planetfish2_bugs/Output/TOA_bug_15/")
setwd(casal_path)
para = get_om_data()
...
################################# CPUE ----
para$ass$sample_years["tagging",,] = 0
# para$ass$sample_years["cpue",c("2005", "2006", "2007", "2008", "2009"),] = 1
para$ass$sample_years["cpue",2:20,] = 1
para$ass$qq_names = "qLL" # turn estimation back on. needed this for casal, it didn't like not having it
para$ass$qqvalues = list(c("1e-6", "1000", "uniform"))



### Load datass to look for qq_names
datass1 = readRDS(file = paste0(casal_path, "datass.RDS"))
...
temp1 = read.csv(paste0(casal_path, "Output_Niter_1008.csv"))
years = 1990:2010
