...
## 5/8/19
##
## SAME AS TOA_BUG_8.R BUT WITH GROWTH CV=0.08 TO FORCE PERFECT SSB ALIGNMENT
## POST-PHIL MEETING
...
## House ----
casal_path = "C:/Users/STA384/Documents/GitHub/planetfish2_bugs/Output/TOA_bug_9.1/"
setwd(casal_path)
para = get_om_data()
